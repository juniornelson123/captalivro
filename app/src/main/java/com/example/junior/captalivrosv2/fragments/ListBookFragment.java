 ...
 * {@link ListBookFragment.OnFragmentInteractionListener} interface
...
public class ListBookFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRecyclerView=(RecyclerView) v.findViewById(R.id.recycler_view_book);

        mRecyclerView.setHasFixedSize(true);

        mList=Book.listAll(Book.class);
